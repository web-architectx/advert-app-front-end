        ...
        <div>
            ...
            >
                <Modal.Header closeButton>
                    <Modal.Title className='text-3xl font-extrabold text-center text-gray-800 mb-4 leading-tight'>
                        Create an Account
                    </Modal.Title>
                </Modal.Header>

                <Modal.Body className='w-full bg-white rounded-lg shadow-lg p-8 overflow-auto'>
